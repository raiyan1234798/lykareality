        ...
        <section ref={ref} className="py-32 bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-gold-500 font-medium mb-4 tracking-widest uppercase text-sm">Elevate Your Career</h2>
                        ...
                        <div className="space-y-6">
                            {[
                                { icon: <Award className="w-6 h-6 text-gold-500" />, title: "Certification Programs", desc: "Recognized excellence in luxury real estate." },
                                { icon: <Building2 className="w-6 h-6 text-gold-500" />, title: "Developer Insights", desc: "Direct briefings from Emaar, DAMAC, and more." },
                                { icon: <BookOpen className="w-6 h-6 text-gold-500" />, title: "Sales Frameworks", desc: "Psychology-driven closing strategies." },
                            ].map((item, i) => (
                                <div key={i} className="flex gap-4 items-start group">
                                    <div className="p-3 rounded-lg bg-zinc-900 group-hover:bg-gold-500/10 transition-colors border border-white/5 group-hover:border-gold-500/30">
                                        {item.icon}
                                    </div>
                                    <div>
                                        <h4 className="text-xl font-semibold text-white mb-1 group-hover:text-gold-400 transition-colors">{item.title}</h4>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 border-[4px] border-gold-500/20 m-6 rounded-xl z-20 pointer-events-none" />

                        <div className="absolute bottom-10 left-10 right-10 z-30">
                            <div className="bg-black/40 backdrop-blur-xl border border-white/10 p-6 rounded-xl relative overflow-hidden">
                                ...
                                <p className="text-gold-400 text-sm text-center font-bold tracking-widest uppercase">The Lykaa Standard</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
